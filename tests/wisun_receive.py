        ...
        "surroundings": [
            {
                ...
                "rssi_em": int(numbers[0]),
                "rssi_mg": int(numbers[1]),
...
if __name__ == "__main__":
    ...
    #url=  "https://0a07-61-114-97-247.ngrok-free.app"#engrog url
    #url="http://fa76b88532ba.ngrok.app/"
    #url="https://buoy.ngrok-free.app"
    url="https://e1fc-61-114-97-102.ngrok-free.app"
    url = url + "/handle"
    print(url)
    main()